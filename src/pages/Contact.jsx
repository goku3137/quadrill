      ...
      <section className="section">
        <div className="container grid-2" style={{ alignItems: 'flex-start' }}>
          ...
          <div>
            ...
            {/* Map Placeholder */}
            <div style={{ height: '300px', backgroundColor: '#e5e7eb', borderRadius: 'var(--radius-md)', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <div style={{ textAlign: 'center', color: 'var(--concrete-grey)' }}>
                <MapPin size={48} style={{ margin: '0 auto 0.5rem' }} />
